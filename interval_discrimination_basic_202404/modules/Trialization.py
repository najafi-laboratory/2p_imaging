...
def trial_label(
    ...
    neural_trials.pop(str(len(neural_trials)-1))
    for i in range(len(neural_trials)):
        neural_trials[str(i)]['trial_types'] = bpod_sess_data['trial_types'][i]
        neural_trials[str(i)]['trial_isi_pre'] = bpod_sess_data['trial_isi_pre'][i]
        neural_trials[str(i)]['trial_isi_post'] = bpod_sess_data['trial_isi_post'][i]
        neural_trials[str(i)]['trial_stim_start'] = bpod_sess_data[
            'trial_stim_start'][i] + neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_stim_seq'] = bpod_sess_data[
            'trial_stim_seq'][i] + neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_lick'] = bpod_sess_data['trial_lick'][i]
        neural_trials[str(i)]['trial_lick'][0,:] += neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_reaction'] = bpod_sess_data['trial_reaction'][i]
        neural_trials[str(i)]['trial_reaction'][0,:] += neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_decision'] = bpod_sess_data['trial_decision'][i]
        neural_trials[str(i)]['trial_decision'][0,:] += neural_trials[str(i)]['vol_time'][0]
        ...
        neural_trials[str(i)]['trial_wrinit'] = bpod_sess_data[
            'trial_wrinit'][i] + neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_notcho'] = bpod_sess_data[
            'trial_notcho'][i] + neural_trials[str(i)]['vol_time'][0]
    return neural_trials
