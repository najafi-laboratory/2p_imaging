...
def plot_js_VIPTD_G8(ops, session_data_name):
    ...
    def plot_session_report():
        ...
        beh_js_short_ax01 = plt.subplot(gs[5, 0])
        beh_js_short_ax02 = plt.subplot(gs[5, 1])
        beh_js_short_ax03 = plt.subplot(gs[5, 2])
        beh_js_short_ax04 = plt.subplot(gs[5, 3])
        beh_js_short_ax05 = plt.subplot(gs[5, 4])
        beh_js_short_ax06 = plt.subplot(gs[5, 5])
        beh_js_short_ax07 = plt.subplot(gs[5, 6])
        beh_js_short_ax08 = plt.subplot(gs[5, 7])
        beh_js_short_ax09 = plt.subplot(gs[5, 8])
        ...
        plotter_beh.short_align_pos_reward(beh_js_short_ax07)
        plotter_beh.short_align_pos_punish(beh_js_short_ax08)
        plotter_beh.short_align_pos_retract2(beh_js_short_ax09)
        beh_js_long_ax01 = plt.subplot(gs[14, 0])
        beh_js_long_ax02 = plt.subplot(gs[14, 1])
        beh_js_long_ax03 = plt.subplot(gs[14, 2])
        beh_js_long_ax04 = plt.subplot(gs[14, 3])
        beh_js_long_ax05 = plt.subplot(gs[14, 4])
        beh_js_long_ax06 = plt.subplot(gs[14, 5])
        beh_js_long_ax07 = plt.subplot(gs[14, 6])
        beh_js_long_ax08 = plt.subplot(gs[14, 7])
        beh_js_long_ax09 = plt.subplot(gs[14, 8])
        ...
        plotter_beh.long_align_pos_reward(beh_js_long_ax07)
        plotter_beh.long_align_pos_punish(beh_js_long_ax08)
        plotter_beh.long_align_pos_retract2(beh_js_long_ax09)
        # short.
        vis1_ax01 = plt.subplot(gs[6, 0])
        vis1_ax02 = plt.subplot(gs[7, 0])
        vis1_ax03 = plt.subplot(gs[8, 0])
        ...
        push1_ax01 = plt.subplot(gs[6, 1])
        push1_ax02 = plt.subplot(gs[7, 1])
        push1_ax03 = plt.subplot(gs[8, 1])
        ...
        retract1_ax01 = plt.subplot(gs[6, 2])
        retract1_ax02 = plt.subplot(gs[7, 2])
        retract1_ax03 = plt.subplot(gs[8, 2])
        ...
        vis2_ax01 = plt.subplot(gs[6, 3])
        vis2_ax02 = plt.subplot(gs[7, 3])
        vis2_ax03 = plt.subplot(gs[8, 3])
        ...
        wait2_ax01 = plt.subplot(gs[6, 4])
        wait2_ax02 = plt.subplot(gs[7, 4])
        wait2_ax03 = plt.subplot(gs[8, 4])
        ...
        push2_ax01 = plt.subplot(gs[6, 5])
        push2_ax02 = plt.subplot(gs[7, 5])
        push2_ax03 = plt.subplot(gs[8, 5])
        ...
        outcome_ax01 = plt.subplot(gs[6, 6])
        outcome_ax02 = plt.subplot(gs[7, 6])
        outcome_ax03 = plt.subplot(gs[8, 6])
        outcome_ax04 = plt.subplot(gs[6, 7])
        outcome_ax05 = plt.subplot(gs[7, 7])
        outcome_ax06 = plt.subplot(gs[8, 7])
        ...
        retract2_ax01 = plt.subplot(gs[6, 8])
        retract2_ax02 = plt.subplot(gs[7, 8])
        retract2_ax03 = plt.subplot(gs[8, 8])
        ...
        # long.
        vis1_ax01 = plt.subplot(gs[15, 0])
        vis1_ax02 = plt.subplot(gs[16, 0])
        vis1_ax03 = plt.subplot(gs[17, 0])
        ...
        push1_ax01 = plt.subplot(gs[15, 1])
        push1_ax02 = plt.subplot(gs[16, 1])
        push1_ax03 = plt.subplot(gs[17, 1])
        ...
        retract1_ax01 = plt.subplot(gs[15, 2])
        retract1_ax02 = plt.subplot(gs[16, 2])
        retract1_ax03 = plt.subplot(gs[17, 2])
        ...
        vis2_ax01 = plt.subplot(gs[15, 3])
        vis2_ax02 = plt.subplot(gs[16, 3])
        vis2_ax03 = plt.subplot(gs[17, 3])
        ...
        wait2_ax01 = plt.subplot(gs[15, 4])
        wait2_ax02 = plt.subplot(gs[16, 4])
        wait2_ax03 = plt.subplot(gs[17, 4])
        ...
        push2_ax01 = plt.subplot(gs[15, 5])
        push2_ax02 = plt.subplot(gs[16, 5])
        push2_ax03 = plt.subplot(gs[17, 5])
        ...
        outcome_ax01 = plt.subplot(gs[15, 6])
        outcome_ax02 = plt.subplot(gs[16, 6])
        outcome_ax03 = plt.subplot(gs[17, 6])
        outcome_ax04 = plt.subplot(gs[15, 7])
        outcome_ax05 = plt.subplot(gs[16, 7])
        outcome_ax06 = plt.subplot(gs[17, 7])
        ...
        retract2_ax01 = plt.subplot(gs[15, 8])
        retract2_ax02 = plt.subplot(gs[16, 8])
        retract2_ax03 = plt.subplot(gs[17, 8])
        ...
        # lick.
        lick_ax01 = plt.subplot(gs[15, 9])
        lick_ax02 = plt.subplot(gs[16, 9])
        lick_ax03 = plt.subplot(gs[17, 9])
        plotter_motor.lick_exc(lick_ax01)
        plotter_motor.lick_inh(lick_ax02)
        plotter_motor.lick_heatmap_neuron(lick_ax03)
        # exc/inh comparison.
        ei_short_ax01 = plt.subplot(gs[9, 0])
        ei_short_ax02 = plt.subplot(gs[9, 1])
        ei_short_ax03 = plt.subplot(gs[9, 2])
        ei_short_ax04 = plt.subplot(gs[9, 3])
        ei_short_ax05 = plt.subplot(gs[9, 4])
        ei_short_ax06 = plt.subplot(gs[9, 5])
        ei_short_ax07 = plt.subplot(gs[9, 8])
        ...
        ei_long_ax01 = plt.subplot(gs[18, 0])
        ei_long_ax02 = plt.subplot(gs[18, 1])
        ei_long_ax03 = plt.subplot(gs[18, 2])
        ei_long_ax04 = plt.subplot(gs[18, 3])
        ei_long_ax05 = plt.subplot(gs[18, 4])
        ei_long_ax06 = plt.subplot(gs[18, 5])
        ei_long_ax07 = plt.subplot(gs[18, 8])
        ...
        # epoch.
        ep_js_short_ax01 = plt.subplot(gs[10, 0])
        ep_js_short_ax02 = plt.subplot(gs[10, 1])
        ep_js_short_ax03 = plt.subplot(gs[10, 2])
        ep_js_short_ax04 = plt.subplot(gs[10, 3])
        ep_js_short_ax05 = plt.subplot(gs[10, 4])
        ep_js_short_ax06 = plt.subplot(gs[10, 5])
        ep_js_short_ax07 = plt.subplot(gs[10, 6])
        ep_js_short_ax08 = plt.subplot(gs[10, 8])
        plotter_beh.short_epoch_align_pos_vis1(ep_js_short_ax01)
        plotter_beh.short_epoch_align_pos_push1(ep_js_short_ax02)
        plotter_beh.short_epoch_align_pos_retract1(ep_js_short_ax03)
        plotter_beh.short_epoch_align_pos_vis2(ep_js_short_ax04)
        plotter_beh.short_epoch_align_pos_wait2(ep_js_short_ax05)
        plotter_beh.short_epoch_align_pos_push2(ep_js_short_ax06)
        plotter_beh.short_epoch_align_pos_reward(ep_js_short_ax07)
        plotter_beh.short_epoch_align_pos_retract2(ep_js_short_ax08)
        ep_short_ax01 = plt.subplot(gs[11, 0])
        ep_short_ax02 = plt.subplot(gs[12, 0])
        ep_short_ax03 = plt.subplot(gs[11, 1])
        ep_short_ax04 = plt.subplot(gs[12, 1])
        ep_short_ax05 = plt.subplot(gs[11, 2])
        ep_short_ax06 = plt.subplot(gs[12, 2])
        ep_short_ax07 = plt.subplot(gs[11, 3])
        ep_short_ax08 = plt.subplot(gs[12, 3])
        ep_short_ax09 = plt.subplot(gs[11, 4])
        ep_short_ax10 = plt.subplot(gs[12, 4])
        ep_short_ax11 = plt.subplot(gs[11, 5])
        ep_short_ax12 = plt.subplot(gs[12, 5])
        ep_short_ax13 = plt.subplot(gs[11, 6])
        ep_short_ax14 = plt.subplot(gs[12, 6])
        ep_short_ax15 = plt.subplot(gs[11, 8])
        ep_short_ax16 = plt.subplot(gs[12, 8])
        #ep_short_ax17 = plt.subplot(gs[11, 8])
        #ep_short_ax18 = plt.subplot(gs[12, 8])
        ...
        plotter_percept.short_epoch_reward_exc(ep_short_ax13)
        plotter_percept.short_epoch_reward_inh(ep_short_ax14)
        plotter_motor.short_epoch_retract2_exc(ep_short_ax15)
        plotter_motor.short_epoch_retract2_inh(ep_short_ax16)
        #plotter_percept.short_epoch_punish_exc(ep_short_ax17)
        #plotter_percept.short_epoch_punish_inh(ep_short_ax18)
        ep_js_long_ax01 = plt.subplot(gs[19, 0])
        ep_js_long_ax02 = plt.subplot(gs[19, 1])
        ep_js_long_ax03 = plt.subplot(gs[19, 2])
        ep_js_long_ax04 = plt.subplot(gs[19, 3])
        ep_js_long_ax05 = plt.subplot(gs[19, 4])
        ep_js_long_ax06 = plt.subplot(gs[19, 5])
        ep_js_long_ax07 = plt.subplot(gs[19, 6])
        ep_js_long_ax08 = plt.subplot(gs[19, 8])
        plotter_beh.long_epoch_align_pos_vis1(ep_js_long_ax01)
        plotter_beh.long_epoch_align_pos_push1(ep_js_long_ax02)
        plotter_beh.long_epoch_align_pos_retract1(ep_js_long_ax03)
        plotter_beh.long_epoch_align_pos_vis2(ep_js_long_ax04)
        plotter_beh.long_epoch_align_pos_wait2(ep_js_long_ax05)
        plotter_beh.long_epoch_align_pos_push2(ep_js_long_ax06)
        plotter_beh.long_epoch_align_pos_reward(ep_js_long_ax07)
        plotter_beh.long_epoch_align_pos_retract2(ep_js_long_ax08)
        ep_long_ax01 = plt.subplot(gs[20, 0])
        ep_long_ax02 = plt.subplot(gs[21, 0])
        ep_long_ax03 = plt.subplot(gs[20, 1])
        ep_long_ax04 = plt.subplot(gs[21, 1])
        ep_long_ax05 = plt.subplot(gs[20, 2])
        ep_long_ax06 = plt.subplot(gs[21, 2])
        ep_long_ax07 = plt.subplot(gs[20, 3])
        ep_long_ax08 = plt.subplot(gs[21, 3])
        ep_long_ax09 = plt.subplot(gs[20, 4])
        ep_long_ax10 = plt.subplot(gs[21, 4])
        ep_long_ax11 = plt.subplot(gs[20, 5])
        ep_long_ax12 = plt.subplot(gs[21, 5])
        ep_long_ax13 = plt.subplot(gs[20, 6])
        ep_long_ax14 = plt.subplot(gs[21, 6])
        ep_long_ax15 = plt.subplot(gs[20, 8])
        ep_long_ax16 = plt.subplot(gs[21, 8])
        #ep_long_ax17 = plt.subplot(gs[19, 8])
        #ep_long_ax18 = plt.subplot(gs[20, 8])
        ...
        plotter_percept.long_epoch_reward_exc(ep_long_ax13)
        plotter_percept.long_epoch_reward_inh(ep_long_ax14)
        plotter_motor.long_epoch_retract2_exc(ep_long_ax15)
        plotter_motor.long_epoch_retract2_inh(ep_long_ax16)
        #plotter_percept.long_epoch_punish_exc(ep_long_ax17)
        #plotter_percept.long_epoch_punish_inh(ep_long_ax18)
        # model.
        model_ax01 = plt.subplot(gs[14, 11:13])
        model_ax02 = plt.subplot(gs[15, 11:13])
        model_ax03 = plt.subplot(gs[16, 11:13])
        model_ax04 = plt.subplot(gs[17, 11:13])
        model_ax05 = plt.subplot(gs[18, 11:13])
        model_ax06 = plt.subplot(gs[19, 11:13])
        plotter_model.block_type_population_decode_all(model_ax01)
        plotter_model.block_type_population_decode_early(model_ax02)
        plotter_model.block_type_population_decode_late(model_ax03)
        plotter_model.block_tran_decode_all(model_ax04)
        plotter_model.block_tran_decode_short(model_ax05)
        plotter_model.block_tran_decode_long(model_ax06)
        # example traces.
...
if __name__ == "__main__":
    ...
    session_data_path = 'C:/Users/yhuang887/Projects/joystick_basic_202304/results/FN16_P_20240626_js_t'
