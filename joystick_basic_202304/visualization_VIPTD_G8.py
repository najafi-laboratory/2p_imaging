...
def plot_js_VIPTD_G8(ops, session_data_name):
    ...
    def plot_session_report():
        ...
        # behavior.
        beh_misc_ax01 = plt.subplot(gs[0, 11:13])
        beh_misc_ax02 = plt.subplot(gs[1, 11])
        ...
        plotter_beh.short_align_pos_reward(beh_js_short_ax08)
        plotter_beh.short_align_pos_punish(beh_js_short_ax09)
        ...
        plotter_beh.long_align_pos_reward(beh_js_long_ax08)
        plotter_beh.long_align_pos_punish(beh_js_long_ax09)
        # short.
        ...
        retract2_ax01 = plt.subplot(gs[6, 6])
        retract2_ax02 = plt.subplot(gs[7, 6])
        retract2_ax03 = plt.subplot(gs[8, 6])
        ...
        outcome_ax01 = plt.subplot(gs[6, 7])
        outcome_ax02 = plt.subplot(gs[7, 7])
        outcome_ax03 = plt.subplot(gs[8, 7])
        outcome_ax04 = plt.subplot(gs[6, 8])
        outcome_ax05 = plt.subplot(gs[7, 8])
        outcome_ax06 = plt.subplot(gs[8, 8])
        ...
        retract2_ax01 = plt.subplot(gs[15, 6])
        retract2_ax02 = plt.subplot(gs[16, 6])
        retract2_ax03 = plt.subplot(gs[17, 6])
        ...
        outcome_ax01 = plt.subplot(gs[15, 7])
        outcome_ax02 = plt.subplot(gs[16, 7])
        outcome_ax03 = plt.subplot(gs[17, 7])
        outcome_ax04 = plt.subplot(gs[15, 8])
        outcome_ax05 = plt.subplot(gs[16, 8])
        outcome_ax06 = plt.subplot(gs[17, 8])
        ...
        ei_short_ax07 = plt.subplot(gs[9, 6])
        ...
        ei_long_ax07 = plt.subplot(gs[18, 6])
        ...
        ep_js_short_ax08 = plt.subplot(gs[10, 7])
        ...
        plotter_beh.short_epoch_align_pos_retract2(ep_js_short_ax07)
        plotter_beh.short_epoch_align_pos_reward(ep_js_short_ax08)
        ...
        ep_short_ax15 = plt.subplot(gs[11, 7])
        ep_short_ax16 = plt.subplot(gs[12, 7])
        ...
        plotter_percept.short_epoch_reward_exc(ep_short_ax15)
        plotter_percept.short_epoch_reward_inh(ep_short_ax16)
        ...
        ep_js_long_ax08 = plt.subplot(gs[19, 7])
        ...
        plotter_beh.long_epoch_align_pos_retract2(ep_js_long_ax07)
        plotter_beh.long_epoch_align_pos_reward(ep_js_long_ax08)
        ...
        ep_long_ax15 = plt.subplot(gs[20, 7])
        ep_long_ax16 = plt.subplot(gs[21, 7])
        ...
        plotter_percept.long_epoch_reward_exc(ep_long_ax15)
        plotter_percept.long_epoch_reward_inh(ep_long_ax16)
        #plotter_percept.long_epoch_punish_exc(ep_long_ax17)
        #plotter_percept.long_epoch_punish_inh(ep_long_ax18)
        # model.
        model_ax01 = plt.subplot(gs[5, 10:12])
        model_ax02 = plt.subplot(gs[6, 10:12])
        model_ax03 = plt.subplot(gs[7, 10:12])
        model_ax04 = plt.subplot(gs[8, 10:12])
