...
def plot_standard_isi_distribution(ax, list_neural_trials):
    ...
    ax.set_xticklabels(
        ...
        rotation='vertical')
    add_legend(ax, ['mediumseagreen','coral'], ['short standard', 'long standard'], 'upper right')
...
def plot_oddball_isi_distribution(ax, list_neural_trials):
    ...
    ax.set_xticklabels(
        500*np.arange(isi_range[0], isi_range[1]/500+1).astype('int32'),
        rotation='vertical')
    add_legend(ax, ['mediumseagreen', 'coral'], ['short oddball', 'long oddball'], 'upper right')
...
def plot_stim_label(ax, list_neural_trials):
    ...
    add_legend(ax, colors, labels, 'upper right')
