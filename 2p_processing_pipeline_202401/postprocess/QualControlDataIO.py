...
def thres_stat(ops, stat, range_footprint, range_skew, max_connect):
...
def run(
        ops,
        range_footprint, range_skew, max_connect,
        run_qc=True
        ):
    print('===============================================')
    ...
    if run_qc:
        bad_roi_id = thres_stat(ops, stat, range_footprint, range_skew, max_connect)
