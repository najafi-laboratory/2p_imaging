...
def plot_fig2(
    ...
    try:
        ...
        mean_fluo_0 = np.mean(dff[labels==0, :], axis=0)
        ...
        for f in tqdm(range(num_figs)):
            ...
            axs[0].plot(
                sub_vol_time,
                (sub_vol_stim_bin - 0.5) * 2 * 3,
                color='grey',
                label='stimulus',
                lw=0.5)
            axs[0].plot(
                sub_time_img,
                normz(sub_mean_fluo_0),
                color='dodgerblue',
            ...
            for i in range(dff.shape[0]):
                ...
                axs[i+2].plot(
                    sub_time_img,
                    normz(sub_dff[i,:]),
                    color=fluo_color[labels[i]],
                    label=fluo_label[labels[i]],
                    lw=0.5)
