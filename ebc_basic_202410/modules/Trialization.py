...
def trial_label(
    ...
    for i in range(np.min([len(neural_trials), len(bpod_sess_data['trial_types'])])):
        ...
        neural_trials[str(i)]['LED'] = bpod_sess_data['trial_LED'][i] + neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['AirPuff'] = bpod_sess_data['trial_AirPuff'][i] + neural_trials[str(i)]['vol_time'][0]
        neural_trials[str(i)]['trial_type'] = bpod_sess_data['trial_types'][i]
        neural_trials[str(i)]['ITI'] = bpod_sess_data['trial_ITI'][i] + neural_trials[str(i)]['vol_time'][0]
