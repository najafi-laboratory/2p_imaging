...
list_session_data_path = [
    'F:\\Single_Interval_discrimination\\Data_2p\\YH24LG_CRBL_lobulev_20250630_2afc-532',
    'F:\\Single_Interval_discrimination\\Data_2p\\YH24LG_CRBL_lobulev_20250701_2afc-533',
...
for i, session_path in enumerate(list_session_data_path):
    ...
    # decoder_decision(neural_trials, labels, l_frames=60, r_frames=120, save_path=session_path, pooling=False)
...
print('####################################################')
summay_path = 'F:\\Single_Interval_discrimination\\Data_2p\\Summary_1'
