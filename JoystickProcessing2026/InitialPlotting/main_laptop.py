# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 16:31:00 2026
...
subject_id = 'SA16_'
date = '20260401/'
output_dir_onedrive = os.path.join('C:/Users/Sana/OneDrive - Georgia Institute of Technology/2p imaging/Figures', subject, 'all_figs', date)
output_dir_local = output_dir_onedrive
initial_path = 'E:\extra'
# sa16
...
master_pdf_name = 'all_sessions_analysis_new.pdf'
...
post_list = [45, 45, 45, 45, 45, 45, 45, 45, 1]
my_conditions = {'outcome': 1}
master_pdf_name = 'all_sessions_analysis_with_pupil1.pdf'
existing_pdf_path = os.path.join(output_dir_onedrive, master_pdf_name)
main_plots.create_initial_pdf(output_dir_onedrive, filename = master_pdf_name)

my_conditions = {'types': 1}
