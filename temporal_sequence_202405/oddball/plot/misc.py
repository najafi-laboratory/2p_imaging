...
def plot_significance(ax, significance):
    labels = ['r_normal', 'r_change', 'r_oddball']
    respon = [
        [np.sum(significance['r_normal']==0), np.sum(significance['r_normal']==1)],
        [np.sum(significance['r_change']==0), np.sum(significance['r_change']==1)],
        [np.sum(significance['r_oddball']==0), np.sum(significance['r_oddball']==1)]]
