...
parser.add_argument('--train_datasets_size', type=int, default=8192, help='How many patches will be used for training.')
...
parser.add_argument('--datasets_folder', type=str, default='./', help="A folder containing files for training")
